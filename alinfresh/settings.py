"""
Django settings for alinfresh project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '13.49.44.199','0.0.0']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'coreapp.context_processer.menu_links',
            ],
        },
    },
]
...
AUTHENTICATION_BACKENDS = [
    # 'coreapp.authentication.CustomAuthenticationBackend',
